...
# измененными записями считаются те, которые есть в auto_tmp и auto_hist 
# (по auto_key)  но одно из бизнес полей отличается
...
def update_auto_hist():
	...
	# актуализировать измененные данные в auto_hist
	...
	# актуализировать удаленные данные в auto_hist
...
# создать функцию, которая удаляет все временные таблицы
...
# 1 создать представление v_auto с актуальным срезом
# 2 заменить auto_hist на v_auto при формировании временных таблиц
